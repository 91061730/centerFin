        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <form action="despesa?acao=editar" method="post">
                    <input type="hidden" name="codigo" value="${despesa.id}">

                    <div class="form-group">
                        <label for="id-descricao">Despesa</label>
                    ...
                    <div class="form-group">
                        <label for="id-pagamento">Forma de Pagamento</label>
                        <input type="text" name="pagamento" id="id-pagamento" class="form-control" value="${despesa.formaPagamento}">
                    </div>
                    <div class="form-group">
                        <label for="id-data">Data de Pagamento</label>
                        <input type="date" name="data" id="id-data" class="form-control" value="${despesa.data}">
                    </div>
