...
<main class="flex-fill container my-4">
    <div class="mt-5 ms-5 me-5">
        <div class="card mb-3">
            ...
            <div class="card-body">
                <form action="receita?acao=editar" method="post">

                    <input type="hidden" name="codigo" value="${receita.id}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="data" id="id-data" class="form-control" value="${receita.data}">
                    </div>
